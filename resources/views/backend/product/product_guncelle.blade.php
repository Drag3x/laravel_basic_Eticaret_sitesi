...
@section('breadcrumbs')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1>Ürün Güncelleme / {{ $productkey->product_name }}</h1>
        </div>
        <div class="col-sm-6">
    ...
    <form action="{{ route("admin.product.productEklePost") }}" enctype="multipart/form-data" method="POST">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="text" value="{{ $productkey->product_name }}" name="product_name" class="form-control" id="exampleInputEmail1" placeholder="Ürün İsmi">
            </div>
            <div class="form-group">
                <label for="exampleInputPassword1">İçerik</label>
                <textarea name="product_text" class="form-control" rows="3" placeholder="Enter ...">{{ $productkey->product_text }}</textarea>
            </div>
            <div class="form-group">
                <label for="exampleInputEmail1">Ürün Fiyati</label>
                <input type="text" value="{{ $productkey->product_money }}" name="product_money" class="form-control" id="exampleInputEmail1" placeholder="Ürün Fiyati">
            </div>
